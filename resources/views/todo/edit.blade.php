...
@section('title', 'Редактировать todo')
    ...
    <form action="{{ route('todos.update', $todo) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" id="exampleInputEmail1"
                   aria-describedby="emailHelp" value="{{ old('title', $todo->title) }}">
        ...
        <div class="mb-3">
            ...
            <div id="emailHelp" class="form-text">Не более 8 МБ, необязательно, сохранится старая</div>
        </div>
